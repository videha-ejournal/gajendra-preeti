...
export default function StructuredData({english=false}:{english?:boolean}){
 ...
 const graph={'@context':'https://schema.org','@graph':[...people,...records,originalChildrenSeries,englishChildrenSeries,{'@type':'CollectionPage','@id':pageUrl,url:pageUrl,name:english?'Preeti Thakur & Gajendra Thakur — Videha Literary Atlas':'प्रीति ठाकुर आ गजेन्द्र ठाकुर',inLanguage:english?'en':'mai',dateModified:'2026-09-10',about:[...people.map(p=>({'@id':p['@id']})),{'@id':originalChildrenSeries['@id']},{'@id':englishChildrenSeries['@id']}],mainEntity:{'@type':'ItemList',numberOfItems:records.length,itemListElement:records.map((r,i)=>({'@type':'ListItem',position:i+1,item:{'@id':r['@id']}}))}}]};
