...
const replacements=new Map([
 ...
 ['THE READING ROOM / ENGLISH CRITICISM','पाठ-कक्ष / मैथिली समालोचना'],['Sources checked: 13 September 2026','स्रोत-जाँच: 13 सितम्बर 2026'],
 ...
 ['A QUESTION TO CARRY BACK','फेर मूल पाठक दिस लऽ जाएबला प्रश्न'],['THE BASIS OF THIS ASSESSMENT','एहि अध्ययनक आधार'],['Examples consulted · PDF pages','देखल उदाहरण · PDF पृष्ठ'],['Page numbers include front matter; viewer numbering may differ.','पृष्ठ-संख्या आरम्भिक सामग्री सहित अछि; viewer क क्रम भिन्न भऽ सकैत अछि।'],['Read the source edition','मूल संस्करण पढ़ू'],['Catalogue context:','सूची-सन्दर्भ:'],['Consulted 13 September 2026.','देखल गेल: 13 सितम्बर 2026।'],['Full method and coverage','सम्पूर्ण पद्धति आ कवरेज'],['CONTINUE THE CONVERSATION','आगाँ पढ़ू'],['Read alongside','संग-संग पढ़ू'],['FROM THE EDITED VOLUMES','सम्पादित पोथीसभसँ'],['Contributors’ perspectives','योगदानकर्तासभक दृष्टि'],['Summaries of signed contributions; related editions and projects are distinguished on the source pages.','हस्ताक्षरित योगदानक सार; सम्बद्ध संस्करण आ परियोजना स्रोत-पन्नापर अलग चिन्हित अछि।'],['← PREVIOUS','← पछिला'],['NEXT →','अगिला →'],['Return to all readings →','सभ पाठक दिस लौटू →'],
 ['Literature invites another reading.','साहित्य फेर पढ़बाक निमन्त्रण दैत अछि।'],['The literary atlas ↗','साहित्यिक एटलस ↗'],['Sources & method','स्रोत आ पद्धति'],['Back to top ↑','ऊपर लौटू ↑'],['Site updated: 13 September 2026','साइट अद्यतन: 13 सितम्बर 2026'],['GitHub repository ↗','GitHub repository ↗'],['English editorial notes prepared with AI assistance for this atlas · 13 September 2026.','एहि एटलस लेल मैथिली समालोचनात्मक पाठ AI-सहायतासँ तैयार कएल गेल · 13 सितम्बर 2026।'],['Source and automated checks were performed during preparation. Review status: no named human editorial review is recorded. These notes are not signed by the featured writers.','तैयारीमे स्रोत-जाँच आ स्वचालित जाँच कएल गेल। समीक्षा-स्थिति: कोनो नामित मानवीय सम्पादकीय समीक्षा दर्ज नहि अछि। ई टिप्पणीक लेखक विशेष रूपसँ प्रस्तुत रचनाकार नहि छथि।'],
