...
let count=0;
for(const [id,key] of Object.entries({'nav-pankhi':'nav','kut-naam':'kut'})){
...
console.log(`Six-book readings PASS: ${count} distinct discussions, paired languages, complete coverage of Nav Pankhi and Kut Naam, source ranges and stable cross-language anchors.`);
