...
let count=0;
for(const [id,key] of Object.entries({'akulait-sur':'akulait','bijji':'bijji','diwan-e-videha':'diwan','diwan-e-videha-khand-2':'diwan2','sahasrabadhani':'sahasrabadhani','sahasrashirsha':'sahasrashirsha','kut-naam':'kut','nav-pankhi':'nav','saatam-sakshi':'saatam','paatak-bhitar-likhal-naam':'paatak'})){
...
console.log(`Six-book readings PASS: ${count} distinct discussions, paired languages, complete coverage of all ten supplied editions, source ranges and stable cross-language anchors.`);
