...
for(const r of readings){const text=read(`criticism/${r.id}.html`);assert.match(text,/id="evidence"/);assert.match(text,/id="question"/);assert.match(text,/prepared with AI assistance/);}
